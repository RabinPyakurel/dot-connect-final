...
import MedicationFormModal from "./Pages/MedicationFormModal";
import DiagnosisFormModal from "./Pages/DiagnosisFormModal";
import CheckUpFormModal from "./Pages/CheckUpsFormModal";
...
const Dashboard: React.FC = () => {
  ...
  const [isCheckUpsModalOpen, setCheckUpsModalOpen] = useState(false);
  ...
  const handleOpenCheckUpsModal=()=>{
    setCheckUpsModalOpen(true)
  };
  ...
  const dropdownMenu = (
    <Menu>
      <Menu.Item key="1" onClick={() =>handleOpenMedicationModal()}>
        Add Medication
      </Menu.Item>
      <Menu.Item key="2" onClick={() => handleOpenDiagnosisModal()}>
        Add Diagnosis
      </Menu.Item>
      <Menu.Item key="3" onClick={() => handleOpenCheckUpsModal()}>
        Add Checkup
      </Menu.Item>
    </Menu>
  );
            ...
            <Card className=" d-flex justify-content-center">
              <Form layout="inline" onFinish={onSearch}>
                ...
                <Form.Item
                  ...
                  name="birthYear"
                  rules={[
                    { required: true, message: "Enter date of birth year" },
                    {
                      pattern: /^\d{4}$/,
            ...
            {loading ? (
              ...
              <>
                ...
                <MedicationFormModal
                  ...
                  onClose={setMedicationModalOpen}
                />
                <DiagnosisFormModal
                  patientId={patientData?.patientId ?? null}
                  isOpen={isDiagnosisModalOpen}
                  onClose={setDiagnosisModalOpen}
                />
                <CheckUpFormModal
                  patientId={patientData?.patientId ?? null}
                  isOpen={isCheckUpsModalOpen}
                  onClose={setCheckUpsModalOpen}
                />
              </>
            ) : (
